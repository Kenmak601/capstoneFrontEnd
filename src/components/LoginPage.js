...
export default function SignIn() {
    ...
    fetch("http://localhost:4000/capstoneProject/Login", {
        method: "POST",
        ...
        {
            alert(`Login Successful, Welcome ${data.get('username')}` );
            setCurrentUserInfo(response.currentUser)
            setAuthenticated(true)
            navigate('/UserHomePage');
        }
        else if (response.status === "Login fail")
        {
        ...
        >
          ...
          <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
            ...
            <Grid container>
              ...
              <Grid item>
                <Link component={NavLink} to="/signUpForm" variant="body2">
